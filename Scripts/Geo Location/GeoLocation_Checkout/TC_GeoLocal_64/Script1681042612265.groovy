...
WebUI.navigateToUrl(GlobalVariable.DigitalItemLink)
...
not_run: WebUI.callTestCase(findTestCase('CommonMethods/SingleProductSelectSearch_hp'), [('searchTerm') : GlobalVariable.CollectionItem], 
    FailureHandling.STOP_ON_FAILURE)
